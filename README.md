...
> 当前版本： v0.2.2 **此版本包括一些设置、显示更改！** 升级至此版本，将默认迁移1次custom.js中自定义的默认数据，详见自定义设置一节。

> **其他**：详见更新日志CHANGELOG.md；
> [更新日志（网页）](CHANGELOG.md) 
> 
> 插入时模式为`默认`、启用自动刷新、层级1、分栏1、大纲层级3。
>
...
4. 导图；（依赖Markmap）
5. 预览方格；（同时提供子文档的开头部分内容预览，子文档为空，则显示子文档的子文档链接）
6. 按日期分组；（按创建/更新日期倒序分组显示）
7. 本地文件夹；（从指定的本地文件夹开始，创建文件夹目录列表）（仅桌面端）
